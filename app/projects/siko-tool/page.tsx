...
const phases = [
  ...
  { id: "A2", label: "Protection Needs",   color: "emerald",description: "Schutzbedarf derived automatically from A1 information categories using the MAX principle — no manual re-assessment." },
  ...
  { id: "A5", label: "Risk Analysis",      color: "red",    description: "Identify and assess risks for assets with elevated protection needs — directly linked to A1/A2 data." },
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <FadeIn>
            <div className="mb-4 flex items-center gap-3">
              ...
              <span className="rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-0.5 text-xs font-medium text-amber-400">Consulting</span>
            </div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-muted-foreground">
              A purpose-built GRC tool for BSI IT-Grundschutz Standard 200-2 — turning a
              month-long manual documentation exercise into a guided, auto-synced workflow
            ...
            <FadeIn direction="right" delay={0.15}>
              <div className="space-y-3">
                {[
                  ...
                  { label: "Typical project duration (manual)", value: "3–6 months", color: "text-red-400" },
                  { label: "With SiKo Tool", value: "Weeks", color: "text-emerald-400" },
                ].map((row) => (
        ...
        <div className="mx-auto max-w-7xl px-6">
          <FadeIn>
            ...
            <p className="mb-12 max-w-xl text-base text-muted-foreground">
              IT-Grundschutz is thorough — and that thoroughness is the problem. In practice,
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                body: "In A2, each asset's Schutzbedarf must be assessed individually. With dozens of linked systems, this is painstaking — and any change in A1 requires redoing the assessment by hand.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center">
            <FadeIn direction="left">
              ...
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
                A GRC tool built for this standard — and nothing else
              </h2>
              <p className="mt-5 text-base leading-relaxed text-muted-foreground">
